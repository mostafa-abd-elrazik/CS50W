    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('starting_bid', models.DecimalField(decimal_places=2, default=20, max_digits=100)),
                ('img_url', models.URLField(blank=True, null=True)),
                ('category', models.CharField(choices=[('Toys', 'Toys'), ('Electronics', 'Electronics'), ('Mobiles', 'Mobiles')], default='Toys', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('current_bid', models.DecimalField(decimal_places=2, default=20, max_digits=100)),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bidder', to=settings.AUTH_USER_MODEL)),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auctions.Listing')),
